...
class PluginApiController extends Controller
{
	...
	#[\Spatie\RouteAttributes\Attributes\Get('Plugin/load')]
	...
	#[\Spatie\RouteAttributes\Attributes\Get('Plugin/unload')]
	...
	#[\Spatie\RouteAttributes\Attributes\Get('Plugin/loaded')]
